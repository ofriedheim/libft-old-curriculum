...
SRC_ADD	=	ft_memalloc.c ft_memdel.c ft_putchar.c \
...
SRC_BON =	ft_lstadd.c ft_lstdel.c ft_lstdelone.c \
			ft_lstiter.c ft_lstmap.c ft_lstnew.c \

SRC_EXTRA = ft_list_push_back.c ft_list_size.c ft_putnbr_base.c \
			ft_putnbr_base_fd.c \
